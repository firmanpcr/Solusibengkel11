...
@section('content')
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="{{ route('user.create') }}" class="btn btn-sm" style="background-color: #333333; color: white; d-inline-flex align-items-center;">
        ...
        <div class="card border-0 shadow mb-4">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-centered table-nowrap mb-0 rounded" id="tabel-user">
