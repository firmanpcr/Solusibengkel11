...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Tambah Data Mekanik</h2>
            <p class="mb-0">Form tambah data mekanik baru </p>
        </div>
    ...
    <div class="card card-body border-0 shadow mb-4">
        ...
        <form action="{{ route('mekanik.store') }}" method="POST">
            ...
            <div class="mt-3">
                <button class="btn" style="background-color: #333333; color: white; mt-2 animate-up-2" type="submit"
                    fdprocessedid="rhm4vh">Simpan</button>
            </div>
        </div>
        </form>
        </form>
