                    ...
                    <div class="col-md-6 mb-3">
                        <div>
                            ...
                            <input class="form-control" id="last_name" name="last_name"
                                value="{{ $dataPelanggan->last_name }}" type="text"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input data-datepicker="" class="form-control" id="birthday" name="birthday"
                                value="{{ $dataPelanggan->birthday }}" type="date" placeholder="dd/mm/yyyy"
                                required>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="email" name="email"
                                value="{{ $dataPelanggan->email }}" type="email"
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="phone" name="phone"
                                value="{{ $dataPelanggan->phone }}"type="number" placeholder="+12-345 678 910"
                                required>
                        </div>
                    </div>
                </div>
